...
window.AUTH = {
  ...
  // MD 로그인 팀 목록 (중복/약어 정리한 고정 리스트 — 자유롭게 추가/수정하세요)
  // 통합 처리: 건강식품1팀→건식1팀, 건강식품2팀→건식2팀, 기타팀→기타,
  //           일반식품→식품팀, 패션→패션팀, Domestic→국내DT팀
  mdTeams: [
    '가전팀', '리빙팀', '주방팀', '식품팀', '건강식품팀', '건식1팀', '건식2팀',
    '뷰티1팀', '뷰티2팀', '뷰티팀', '패션팀', '패션상품개발팀', '트렌드패션팀',
    '캐주얼팀', '레포츠팀', '잡화팀', '잡화명품팀', '잡화레포츠', '패션잡화',
    '국내DT팀', '테마파트', '기타',
  ],
